@extends('layouts.master', ['title' => 'Case Sub Category'])
                ...
                <div class="col-12">
                    <div class="box_header common_table_header xs_mb_0">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px" >Case Sub Category</h3>
                            <ul class="d-flex">
                            @if(permissionCheck('category.subcase.store'))

                                <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{ route('category.subcase.create') }}"><i class="ti-plus"></i>Add Case Sub Category</a></li>
                            @endif
                            </ul> 
                        </div>
                    </div>
