...
class CaseSubCategoryController extends Controller
{
    public function __construct()
    {
        $this->middleware('limit:case_sub_category')->only(['create', 'store']);
    }
    /**
    ...
    {
        $models = CaseSubCategory::all();
        return view('category.subcategory.index', compact('models'));
    }
    ...
    public function create()
    {
        ...
        if (request()->ajax() and $quick_add == 1) {
            return view('category.subcategory.create_modal');
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->quick_add == 1) {
            $response['appendTo'] = '#case_sub_category_id';
        }
