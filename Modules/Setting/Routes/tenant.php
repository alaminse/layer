...
Route::prefix('setting')->middleware('auth', 'check.plan')->group(function () {
...
Route::prefix('style')->middleware(['auth', 'check.plan'])->group(function() {
...
Route::group(['middleware' => ['auth', 'check.plan', 'permission', 'saasAdmin']], function () {
