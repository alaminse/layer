                ...
                <div class="col-lg-{{ auth()->user()->can('dashboard_todo.index') ? 5 : 6 }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 text-right">
                            <a href="#" data-toggle="modal" class="primary-btn small fix-gr-bg" data-target="#add_to_do"
                            ...
                            <div class="white-box school-table">
                                <div class="row to-do-list mb-20">
                                    <div class="col-md-6 col-6">
                                        <button class="primary-btn small fix-gr-bg" id="toDoList">@lang('todo.Incomplete')</button>
                                    </div>
                                    ...
                                    @if(moduleStatusCheck('Appointment'))
                                        <table class="table pt-0 shadow_none pb-0 ">
                                            ...
                                            <tr>
                                                ...
                                                @if(auth()->user()->id == 1)
                                                <th scope="col">{{ __('common.Lawyer') }}</th>
                                                @endif
                                                <th scope="col">{{ __('appointment.Booked Time') }}</th>
                                                <th scope="col">{{ __('appointment.Share Link') }}</th>
                                            </tr>

                                            @foreach ($appointments as $key => $booking)
                                                <tr>
                                                    <th class="m-2">{{ $loop->iteration }}</th>
                                                    <td>{{ $booking->client->name }}</td>
                                                    <td>{{ showDate($booking->schedule->schedule_date) }}
                                                        <br>[{{ $booking->schedule ? date('h:i A', strtotime(@$booking->schedule->slotInfo->start_time)) :'' }} - {{ $booking->schedule ? date('h:i A', strtotime(@$booking->schedule->slotInfo->end_time)) :'' }}]</td>
                                                    @if(auth()->user()->id == 1)
                                                    ...
                                                    <td>
                                                        @if($booking->share_link)
                                                            <a href="{{ $booking->share_link }}" target="_blank">
                                                                <span class="primary-btn radius_30px mr-10 fix-gr-bg">{{ __('appointment.Link') }}</span>
                                                            </a>
                                                        @else
                                                            <span class="primary-btn radius_30px mr-10 fix-gr-bg" style="background: red">{{ __('appointment.No Link') }}</span>
                                                        @endif
                                                    </td>
                                    ...
                                    <table class="table pt-0 shadow_none pb-0 ">
                                        <tbody>
                                            ...
                                            @foreach ($appointments as $appointment)
                                                <tr>
                                                    <td><a
                                                            href="{{ route('appointment.show', $appointment->id) }}">{{ $appointment->title }}</a>
                                                    </td>
                                    ...
                                    <table class="table pt-0 shadow_none pb-0 ">
                                        <tbody>
                                            ...
                                            @foreach ($upcommingdate as $date)
                                                <tr>
                                                    <td><a
                                                            href="{{ route('case.show', $date->id) }}">{{ $date->title }}</a>
                                                    </td>
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input placeholder="{{ __('common.Date') }}"
                                                                    ...
                                                                    id="startDate" type="text" name="date" value=""
                                                                    autocomplete="off">
                                                            </div>
                                                        </div>
